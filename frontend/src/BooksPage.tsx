   ...
   return (
      <div className='h-screen font-mono p-4'>
         ...
         <AddEditBookModal
            ...
            onOk={bookAddEdit}
         />
         <ViewBookModal book={activeBook && {...activeBook, author: activeBook?.name}} isModalOpen={isViewModalOpen}
                        setIsModalOpen={setIsViewModalOpen}/>
         <DeleteBookModal book={activeBook} isModalOpen={isDeleteModalOpen} setIsModalOpen={setIsDeleteModalOpen}
                          onOk={bookDelete}/>
      </div>
   )
}
