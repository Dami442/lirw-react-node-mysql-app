...
function AuthorsPage() {
                ...
                const authorObj = {
                    ...
                    actions: (
                        <div className='flex space-x-4'>
                            ...
                            <Button type='primary' icon={<IconDelete/>} danger
    ...
    return (
        <div className='h-screen font-mono p-4'>
            ...
            <AddEditAuthorModal initialValues={activeAuthor} isEdit={isEdit} isModalOpen={isAddEditModalOpen}
                                setIsModalOpen={setIsAddEditModalOpen} onOk={authorAddEdit}/>
            <ViewAuthorModal author={activeAuthor} isModalOpen={isViewModalOpen} setIsModalOpen={setIsViewModalOpen}/>
            <DeleteAuthorModal author={activeAuthor} isModalOpen={isDeleteModalOpen}
                               setIsModalOpen={setIsDeleteModalOpen} onOk={authorDelete}/>
        </div>
    )
}
